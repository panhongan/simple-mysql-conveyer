...
public class TableAccessTest extends SpringTest {
    ...
    public void testQueryByCondition_ObjectAndSqlCondition_ObjectConditionIsNull() {
        tableAccess.queryByCondition(null, (SqlCondition) null, null);
    }
    ...
    public void testQueryByCondition_ObjectAndSqlCondition_Ok() {
        ...
        Mockito.when(sqlExecutor.select(Mockito.anyString(), Mockito.anyMap(), Mockito.any())).thenReturn(Collections.emptyList());
        assert(tableAccess.queryByCondition(obj, SqlConditionMaker.equalCondition(obj1), null).isEmpty());
    }

    @Test (expected = IllegalArgumentException.class)
    public void testQueryByCondition_SqlConditionIsNull() {
        tableAccess.queryByCondition(null, null, TestObj.class);
    }
    ...
    public void testQueryByCondition_SqlConditionIsOk() {
        ...
        Mockito.when(sqlExecutor.select(Mockito.anyString(), Mockito.anyMap(), Mockito.any())).thenReturn(Collections.emptyList());
        assert(tableAccess.queryByCondition(SqlConditionMaker.equalCondition(obj), null, TestObj.class).isEmpty());
    }

    @Test (expected = IllegalArgumentException.class)
    public void testQueryByPage_ObjectConditionIsNull() {
        tableAccess.queryByPage(null, null, new PageContext());
    }
    ...
    public void testQueryByPage_ObjectConditionIsOk() {
        ...
        Mockito.when(sqlExecutor.select(Mockito.anyString(), Mockito.anyMap(), Mockito.any())).thenReturn(Collections.emptyList());
        assert(tableAccess.queryByPage(obj, null, pageContext).isEmpty());
    }
    ...
    public void testQueryByPage_ObjectAndSqlCondition_Ok() {
        ...
        Mockito.when(sqlExecutor.select(Mockito.anyString(), Mockito.anyMap(), Mockito.any())).thenReturn(Collections.emptyList());
        assert(tableAccess.queryByPage(obj, SqlConditionMaker.equalCondition(obj1), null, pageContext).isEmpty());
    }

    @Test (expected = IllegalArgumentException.class)
    public void testQueryByPage_SqlConditionIsNull() {
        tableAccess.queryByPage(null, null, null, TestObj.class);
    }
    ...
    public void testQueryByPage_SqlConditionIsOk() {
        ...
        Mockito.when(sqlExecutor.select(Mockito.anyString(), Mockito.anyMap(), Mockito.any())).thenReturn(Collections.emptyList());
        assert(tableAccess.queryByPage(SqlConditionMaker.equalCondition(obj), null, pageContext, TestObj.class).isEmpty());
    }
