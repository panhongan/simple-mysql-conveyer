...
public class SqlMaker {
    ...
    public static <D> Pair<String, Map<Integer, String>> makeQueryByConditionSql(String tableName, SqlCondition sqlCondition, Class<D> c) {
        Preconditions.checkArgument(StringUtils.isNotEmpty(tableName), "tableName is empty");
    ...
    public static <D> Pair<Pair<String, String>, Map<Integer, String>> makeQueryByPageSql(String tableName, SqlCondition sqlCondition, PageContext pageContext, Class<D> c) {
        Preconditions.checkArgument(StringUtils.isNotEmpty(tableName), "tableName is empty");
        Preconditions.checkNotNull(sqlCondition, "sqlCondition is null");
        ...
        String baseSql = "from " + tableName + (StringUtils.isNotEmpty(pair.getLeft()) ? " where " : "") + pair.getLeft();
